...
namespace ClusterNet.MeanShift
{
    ...
    internal static partial class PointShifting
    {
            ...
            where TKernel : struct, IKernel
        {
            ...
            TAvgProgress avgProgress = default;
            ...
            for (int i = 0; i < pointCount; i++)
            {
                ...
                double weight = kernel.WeightDistance(distance) * point.Item2;
                avgProgress = shape.AddToAverage(avgProgress, (point.Item1, weight));
            }

            return (shape.FinalizeAverage(avgProgress), p.Item2);
        }
    }
}
